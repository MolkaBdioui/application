            ...
            <div class="col-xl-12">
                <div class="testimonials-one-carousel owl-theme owl-carousel">
                    ...
                    <div class="testimonials-one-single">
                        <div class="client-info">
                            <div class="client-img">
                                <img src="{{ asset('front-assets/images/testimonial/testi-img-1.png') }}"
                                    alt="">
                            </div>
                    ...
                    <div class="testimonials-one-single">
                        <div class="client-info">
                            <div class="client-img">
                                <img src="{{ asset('front-assets/images/testimonial/testi-img-2.png') }}"
                                    alt="">
                            </div>
                            <div class="client-content">
                                <h3>John Pedlock</h3>
                    ...
                    <div class="testimonials-one-single">
                        <div class="client-info">
                            <div class="client-img">
                                <img src="{{ asset('front-assets/images/testimonial/testi-img-3.png') }}"
                                    alt="">
                            </div>
                            <div class="client-content">
                                <h3>Mark Joseph</h3>
