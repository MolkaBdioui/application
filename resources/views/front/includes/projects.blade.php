<section class="latest-projects-one-section">
    <div class="latest-projects-one-bg"
        style="background-image: url({{ asset('front-assets/images/background/project-1-bg.png') }})">
    </div>
    <div class="container">
        <div class="row">
            <div class="col-xl-4">
            ...
            <div class="col-xl-4">
                <div class="latest-pro-one-single">
                    <div class="latest-pro-one-img-box">
                        <img src="{{ asset('front-assets/images/project/project-1-img-1.jpg') }}"
                            alt="">
            ...
            <div class="col-xl-4">
                <div class="latest-pro-one-single">
                    <div class="latest-pro-one-img-box">
                        <img src="{{ asset('front-assets/images/project/project-1-img-2.jpg') }}"
                            alt="">
                        <div class="latest-pro-one-img-title">
                            <div class="content">
