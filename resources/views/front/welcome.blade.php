...
<body>
    ...
    <div class="wrapper_box">
        ...
        <section class="banner-section wow fadeIn">
            <div class="swiper-container banner-slider">
                <div class="swiper-wrapper">
                    <!-- Slide Item -->
                    <div class="swiper-slide" style="background-image: url({{ asset('front-assets/images/main-slider/1.jpg') }});">
                        <div class="content-outer">
                            <div class="content-box">
                                <div class="inner">
                                    
                                    <h1>SmartOP is <br> equipped with the <br>latest <span>technology</span></h1>
                                    <div class="text">Manufacturing Technology Supports Factories around the World.
                                        <br>Factories are at the heart of manufacturing.</div>
                                    <div class="link-box">
                    ...
                    <!-- Slide Item -->
                    <div class="swiper-slide" style="background-image: url({{ asset('front-assets/images/main-slider/2.jpg') }});">
                        <div class="content-outer">
                            <div class="content-box">
                                <div class="inner">
                        ...
                        <div class="about-two-left-content wow slideInLeft" data-wow-delay="100ms">
                            <div class="about-two-sec-image">
                                <div class="about-two-sec-image-bg-1"
                                    style="background-image: url({{ asset('front-assets/images/about/about-2--pattern-1.png') }})"></div>
                                <div class="about-two-sec-image-bg-2"
                                    style="background-image: url({{ asset('front-assets/images/about/about-2--pattern-2.png') }})"></div>
                                <img src="{{ asset('front-assets/images/about/about-page-img-1.jpg') }}" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="about-two-right-content">
                            <div class="about-two-title">
                                <h4 class="sub-title-shape-left section_title-subheading">About SmartOP</h4>
                                
                                <h2> SMARTOP </h2>
                                <p class="about-two-title-text" style="text-align: justify">is an innovative web application designed to revolutionize maintenance management in the aerospace industry. <br/>
                                    Developed as part of Industry 4.0 initiatives, SMARTOP collects real-time data from injection machines, such as temperature, cycle count, and hydraulic pressure, to generate actionable insights.</p>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
        ...
        <section class="funfacts-one-section" style="background-image: url({{ asset('front-assets/images/background/funfact-1-bg.jpg') }})">
            <div class="container">
                <div class="row">
                            ...
                            <div class="content count-box">
                                <h2>
                                    <span class="timer" data-from="1" data-to="780" data-speed="5000"
                                        data-refresh-interval="50">780</span>
                                </h2>
                            ...
                            <div class="content count-box">
                                <h2>
                                    <span class="timer" data-from="1" data-to="189" data-speed="5000"
                                        data-refresh-interval="50">189</span>
                                </h2>
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-md-6">
                        ...
                        <div class="team-one-single wow fadeInLeft" data-wow-delay="100ms">
                            <div class="team-one-img">
                                <img src="{{ asset('front-assets/images/team/team-1-img-1.jpg') }}" alt="">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6">
                        ...
                        <div class="team-one-single wow fadeInLeft" data-wow-delay="200ms">
                            <div class="team-one-img">
                                <img src="{{ asset('front-assets/images/team/team-1-img-2.jpg') }}" alt="">
                                <div class="team-one-hover">
                                    <div class="team-one-social">
                                        <a href="#"><i class="fab fa-facebook-square"></i></a>
                                        <a href="#"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6">
                        ...
                        <div class="team-one-single wow fadeInLeft" data-wow-delay="300ms">
                            <div class="team-one-img">
                                <img src="{{ asset('front-assets/images/team/team-1-img-3.jpg') }}" alt="">
                                <div class="team-one-hover">
                                    <div class="team-one-social">
                                        <a href="#"><i class="fab fa-facebook-square"></i></a>
                                        <a href="#"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6">
                        ...
                        <div class="team-one-single wow fadeInLeft" data-wow-delay="400ms">
                            <div class="team-one-img">
                                <img src="{{ asset('front-assets/images/team/team-1-img-4.jpg') }}" alt="">
                                <div class="team-one-hover">
                                    <div class="team-one-social">
                                        <a href="#"><i class="fab fa-facebook-square"></i></a>
                                        <a href="#"><i class="fab fa-twitter"></i></a>
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="why-choose-two-image">
                            <img src="{{ asset('front-assets/images/resource/why-choose-2-img-1.jpg') }}" alt="">
                        </div>
                    </div>
                    <div class="col-xl-6">
        ...
        <section class="video-two-section" style="background-image: url({{ asset('front-assets/images/background/video-sec-two-bg.jpg') }})">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="video-two-sec-inner">
                            <div class="video-two-sec-icon">
                                <a href="https://www.youtube.com/watch?v=i9E_Blai8vk"
                                    class="video-two-sec-btn video-popup"><i class="fa fa-play"></i></a>
                            </div>
        ...
        <section class="latest-projects-one-section">
            <div class="latest-projects-one-bg" style="background-image: url({{ asset('front-assets/images/background/project-1-bg.png')}})">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-4">
                        <div class="latest-pro-one-title">
                            ...
                            <p>Manufacturing Technology Supports Factories around the World. Factories are at the heart
                                of manufacturing.</p>
                        </div>
                    </div>
                    <div class="col-xl-4">
                        <div class="latest-pro-one-single">
                            <div class="latest-pro-one-img-box">
                                <img src="{{ asset('front-assets/images/project/project-1-img-1.jpg') }}" alt="">
                                <div class="latest-pro-one-img-title">
                                    <div class="content">
                                        <h5><a href="#">Metal & Materials</a></h5>
                                    </div>
                                    <div class="icon"><a class="img-popup"
                                            href="images/project/project-1-img-1.jpg"><span
                    ...
                    <div class="col-xl-4">
                        <div class="latest-pro-one-single">
                            <div class="latest-pro-one-img-box">
                                <img src="{{ asset('front-assets/images/project/project-1-img-2.jpg') }}" alt="">
                                <div class="latest-pro-one-img-title">
                                    <div class="content">
                                        <h5><a href="#">Welding Industry</a></h5>
                                    </div>
                                    <div class="icon"><a class="img-popup"
                                            href="{{ asset('front-assets/images/project/project-1-img-1.jpg') }}"><span
                                                class="flaticon-plus"></span></a></div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="testimonials-one-section two"
            style="background-image: url({{ asset('front-assets/images/background/video-sec-two-bg.jpg') }})">
            <div class="container">
                <div class="thm-section-title text-center">
                    ...
                    <div class="col-xl-12">
                        <div class="testimonials-one-carousel owl-theme owl-carousel">
                            ...
                            <div class="testimonials-one-single">
                                <div class="client-info">
                                    <div class="client-img">
                                        <img src="{{ asset('front-assets/images/testimonial/testi-img-1.png') }}" alt="">
                                    </div>
                            ...
                            <div class="testimonials-one-single">
                                <div class="client-info">
                                    <div class="client-img">
                                        <img src="{{ asset('front-assets/images/testimonial/testi-img-2.png') }}" alt="">
                                    </div>
                                    <div class="client-content">
                                        <h3>John Pedlock</h3>
                                        <h6>Designer</h6>
                            ...
                            <div class="testimonials-one-single">
                                <div class="client-info">
                                    <div class="client-img">
                                        <img src="{{ asset('front-assets/images/testimonial/testi-img-3.png') }}" alt="">
                                    </div>
                                    <div class="client-content">
                                        <h3>Mark Joseph</h3>
                                        <h6>Developer</h6>
                    ...
                    <div class="col-xl-12">
                        <div class="brand-one-carousel owl-carousel">
                            <div class="single_brand_item">
                                <a href="#"><img src="{{ asset('front-assets/images/brand/brand-1-1.jpg') }}" alt="brand"></a>
                            </div>
                            <div class="single_brand_item">
                                <a href="#"><img src="{{ asset('front-assets/images/brand/brand-1-2.jpg') }}" alt="brand"></a>
                            </div>
                            <div class="single_brand_item">
                                <a href="#"><img src="{{ asset('front-assets/images/brand/brand-1-3.jpg') }}" alt="brand"></a>
                            </div>
                            <div class="single_brand_item">
                                <a href="#"><img src="{{ asset('front-assets/images/brand/brand-1-4.jpg') }}" alt="brand"></a>
                            </div>
                            <div class="single_brand_item">
                                <a href="#"><img src="{{ asset('front-assets/images/brand/brand-1-5.jpg') }}" alt="brand"></a>
                            </div>
                            <div class="single_brand_item">
                                <a href="#"><img src="{{ asset('front-assets/images/brand/brand-1-1.jpg') }}" alt="brand"></a>
                            </div>
                            ...
                            <ul class="footer-widget-gallery-list list-unstyled">
                                <li>
                                    <div class="gallery-img">
                                        <img src="{{ asset('front-assets/images/footer/footer-gallery-img-1.jpg') }}" alt="">
                                ...
                                <li>
                                    <div class="gallery-img">
                                        <img src="{{ asset('front-assets/images/footer/footer-gallery-img-2.jpg') }}" alt="">
                                        <div class="gallery-img-hover">
                                            <i class="fa fa-link"></i>
                                        </div>
                                    </div>
                                ...
                                <li>
                                    <div class="gallery-img">
                                        <img src="{{ asset('front-assets/images/footer/footer-gallery-img-3.jpg') }}" alt="">
                                        <div class="gallery-img-hover">
                                            <i class="fa fa-link"></i>
                                        </div>
                                    </div>
                                ...
                                <li>
                                    <div class="gallery-img">
                                        <img src="{{ asset('front-assets/images/footer/footer-gallery-img-4.jpg') }}" alt="">
                                        <div class="gallery-img-hover">
                                            <i class="fa fa-link"></i>
                                        </div>
                                    </div>
                                ...
                                <li>
                                    <div class="gallery-img">
                                        <img src="{{ asset('front-assets/images/footer/footer-gallery-img-5.jpg') }}" alt="">
                                        <div class="gallery-img-hover">
                                            <i class="fa fa-link"></i>
                                        </div>
                                    </div>
                                ...
                                <li>
                                    <div class="gallery-img">
                                        <img src="{{ asset('front-assetsimages/footer/footer-gallery-img-6.jpg') }}" alt="">
                                        <div class="gallery-img-hover">
                                            <i class="fa fa-link"></i>
                                        </div>
                                    </div>
