                                ...
                                <div class="card-body">
                                    <form action="{{ route('projects.save') }}" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="">Project Label</label>
                                            <input type="text" class="form-control" name="label" id="">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="startAt" id="">
                                        </div>
                                        <div class="form-group">
                                            <label for="">End At</label>
                                            <input type="date" class="form-control" name="endAt" id="">
                                        </div>
                                        <div class="form-group">
